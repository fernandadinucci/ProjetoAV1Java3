...
public class Executavel {
	...
	public static void main(String[] args) 
	{
		...
		lj.adicionarCarro("1001", "Ford", "Novo Fiesta", "Branco", "Sedan", 1.6f ,"Automatico", 60000.00f);
		lj.adicionarCarro("1001", "Ford", "Novo Fiesta", "Branco", "Sedan", 1.6f ,"Automatico", 60000.00f);
		lj.adicionarCarro("1002", "Chevrolet", "Celta", "Verde", "Hatch", 1.0f ,"Manual", 10000.00f);
		lj.adicionarCarro("1003", "Fiat", "Palio", "Prata", "Hatch", 1.4f ,"Manual", 18000.00f);
		lj.adicionarCarro("1003", "Fiat", "Palio", "Prata", "Hatch", 1.4f ,"Manual", 18000.00f);
		lj.adicionarCarro("1004", "Ford", "Novo Fiesta", "Vermelho", "Sedan", 1.6f ,"Automatico", 60000.00f);
		lj.adicionarCarro("1005", "Renault", "Duster", "Preto", "SUV", 2.0f ,"Automatico", 80000.00f);
		lj.adicionarCarro("1005", "Renault", "Duster", "Preto", "SUV", 2.0f ,"Automatico", 80000.00f);
		System.out.println();
		lj.listarEstoquedeCarros();
		
		System.out.println("Cadastrando motos...\n");
		lj.adicionarMoto("2001", "Honda", "CG 150 Titan", "Branco",  150 , 20, 6000.00f);
		lj.adicionarMoto("2001", "Honda", "CG 150 Titan", "Branco",  150 , 20, 6000.00f);
		lj.adicionarMoto("2002", "Yamaha", "Factor YBR 125", "Verde", 125, 25, 5000.00f);
		lj.adicionarMoto("2003", "Suzuki", "Yes 125", "Prata", 125, 15, 8000.00f);
		lj.adicionarMoto("2003", "Suzuki", "Yes 125", "Prata", 125, 15, 8000.00f);
		lj.adicionarMoto("2004", "Yamaha", "XTZ", "Vermelho", 125, 23, 7000.00f);
		lj.adicionarMoto("2005", "Honda", "Biz", "Preto", 125, 18, 50000.00f);
		lj.adicionarMoto("2005", "Honda", "Biz", "Preto", 125, 18, 50000.00f);
		System.out.println();
		...
		System.out.println("Pesquisando motos...\n");
